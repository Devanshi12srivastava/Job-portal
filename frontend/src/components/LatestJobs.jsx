  ...
  return (
    <div className="max-w-7xl mx-auto my-16">
      ...
      <div className="grid grid-cols-3 gap-4 my-15">
                        {
                    allJobs.length <= 0 ? <span className="fontbold text-xl text-fuchsia-800 my-15">Oops No jobs found!</span> : allJobs?.slice(0,6).map((job) => <LatestJobCards key={job._id} job={job}/>)
                }
