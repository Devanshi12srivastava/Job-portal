    ...
    <div>
      ...
      <div className="border border-gray-300  shadow-md hover:shadow-lg rounded-xl p-4 sm:p-5 transition-all duration-300 my-10">
        <div className="max-w-4xl mx-auto 00 rounded-2xl my-5 p-8 ">
          <div className="flex justify-between ">
            ...
            <Button
              ...
              className="text-right text-purple-900 bg-purple-200 rounded-4xl border border-gray-500 cursor-pointer shadow-gray-400 h-12 w-12 hover:bg-fuchsia-200"
              variant="outline"
            >
              <Pen />
            </Button>
            ...
            <div className="flex items-center gap-2 ">
              {user?.profile?.skills.length !== 0 ? (
                user?.profile?.skills.map((item, index) => (
                  <Badge className="bg-white text-gray-600" key={index}>
                    {item}{" "}
                  </Badge>
                ))
              ) : (
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="font-bold text-3xl my-5 text-fuchsia-800">
            {" "}
            Your Applied <span className="text-red-600">Jobs</span>
          </h1>
